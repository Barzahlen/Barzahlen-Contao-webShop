...
{
    const APIDOMAIN = 'https://api-staging.barzahlen.de/v1/transactions/'; //!< call domain (productive use)
    const APIDOMAINSANDBOX = 'https://api-sandbox-staging.barzahlen.de/v1/transactions/'; //!< sandbox call domain
